...
public class TimeTableTest {
	...
	@Test
	 ...
	 //testing getApptRange()
		...
		assertEquals(calDays.get(4).getSizeAppts(),1);
		assertEquals(calDays.get(5).getSizeAppts(),1);
		assertEquals(calDays.get(6).getSizeAppts(),1);
		assertEquals(calDays.get(11).getSizeAppts(),1);
		...
		for(int i =0; i< calDays.size();i++){
			...
			i!=65 && i!=96 && i!=126 && i!=157 && i!=215 && i!=222 && i!=229 && i!=312 && i!=677 && i!=1043 && i!=1408){
	...
	@Test
	 ...
	 //testing getApptRange()
		...
		assertEquals(calDays.get(368).getSizeAppts(),1);
		assertEquals(calDays.get(369).getSizeAppts(),1);
		assertEquals(calDays.get(370).getSizeAppts(),1);
		assertEquals(calDays.get(371).getSizeAppts(),1);
		assertEquals(calDays.get(376).getSizeAppts(),1);
		for(int i =0; i< calDays.size();i++){
			//System.out.println(i);
			if(
			i!=368 &&
