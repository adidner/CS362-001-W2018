	...
	/*  @Test
	  ...
	  public void radnomtestHour()  throws Throwable  {	
		...
		for(int i =0; i< 1000;i++){
				 int startHour=ValuesGenerator.getRandomIntBetween(random,-50,70);
				...
				//the line above was to good at finding my bug so i had to adjust it 		
				 if(startHour>26||startHour<0){
	  ...
	  @Test
	  public void radnomtestMonth()  throws Throwable  {	
		long randomseed =System.currentTimeMillis(); //10
				Random random = new Random(randomseed);
